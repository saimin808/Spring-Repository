...
public class RESTController {
	...
	//JSON 형태의 문자열을 응답하면서 이것은 json이라고 표시해줄 수 있다.
	...
	// XML타입으로 자동변환 하기 위해서는 Jackson Dataformat XML 라이브러리를 사용한다.
	...
	public ResponseEntity<String> error1() {
		...
		return ResponseEntity.ok("<html><head><body><h3>Hello!</h3></body></head></html>");
	}
	...
	public ResponseEntity<String> ok2() {
		return ResponseEntity.ok()
							 ...
							 .body("<html><head><body><h3>Hello!</h3></body></head></html>");
	}
